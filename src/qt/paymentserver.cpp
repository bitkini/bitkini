...
const QString BITCOIN_IPC_PREFIX("bitkini:");
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(nullptr, tr("Payment request error"),
                tr("Cannot start bitkini: click-to-pay handler"));
        }
        else {
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("bitkini://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'bitkini://' is not a valid URI. Use 'bitkini:' instead."),
